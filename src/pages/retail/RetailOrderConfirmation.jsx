...
import { CheckCircle, Package, Phone, Mail, MapPin, Calendar, ArrowRight } from 'lucide-react';
          ...
          <div className="bg-primary-50 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-primary-700 text-xs">
                Your distributor will contact you shortly to confirm your order and arrange delivery.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                <p className="font-medium text-gray-900">Distributor Acknowledgment</p>
                <p className="text-sm text-gray-600">Your distributor will review and acknowledge your order within 1 hour</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0 mr-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Transfer payment and upload proof to confirm your order</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0 mr-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Your order will be prepared and delivered based on your selected delivery mode</p>
              </div>
            </div>
          </div>
        </div>
